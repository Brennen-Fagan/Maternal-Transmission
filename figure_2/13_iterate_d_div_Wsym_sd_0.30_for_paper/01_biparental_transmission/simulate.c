...
#define		method_transmit	2	/* transmission of symbionts from host parents to host offspring
					   0: maternal
...
int	flag_timeseries = 0;			/* 1: detailed output for timeseries of realization on 0: off	*/

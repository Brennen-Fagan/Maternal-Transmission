...
#define		method_transmit	3	/* transmission of symbionts from host parents to host offspring
					   0: maternal
...
#define		tmax		40.0	/* maximum time for simulations					*/
...
#define		fmodstart	0.2	/* Starting frequency for gene stopping male transmission:
...
*/	while (t<=tmax)
	{
	    ...
	    /***Number and frequency of hosts with symbiont***/
		param[sp].nsym = 0.0;
		nowP = param[sp].firstP;
		while (nowP != NULL)
